...
class OrderController extends Controller
{
    ...
    private function formatOrderForList(Order $order, string $baseUrl): array
    {
        ...
        return [
            ...
            'payment_gateway' => $this->jsonSafeString($order->payment_gateway),
            'payment_reference' => $this->jsonSafeString($order->payment_reference),
            'transaction_id' => $this->jsonSafeString($order->transaction_id),
            'payment_confirmed_at' => $order->payment_confirmed_at?->toIso8601String(),
            'escrow_status' => $this->jsonSafeString($order->escrow_status),
